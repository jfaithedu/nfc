#!/usr/bin/env python3
"""
Basic Backend System Test

This script provides an interactive interface to test core components of the NFC music player:
- NFC tag detection and writing
- Bluetooth audio connectivity
- Media management (YouTube and local files)
- Database operations

Note: This version does not require the API server and avoids Flask dependencies.
